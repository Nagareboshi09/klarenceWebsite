          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Experienced in building modern, responsive web applications using HTML, CSS, Tailwind, Bootstrap and Javascript.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Strong foundation in algorithms, data structures, programming principles, cyber-security fundamental and network infrastructure.
              </p>
            </motion.div>
