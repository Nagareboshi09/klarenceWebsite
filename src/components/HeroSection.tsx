      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              I am an IT graduate with a background in computer programming, networking, data-base systems, and cyber-security fundamentals. I’ve worked with AI platforms and large language models, using prompt engineering to optimize their outputs. Strong problem-solver with a keen desire for new technology and a willingness to learn more. 
            </motion.p>
