  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "deguzman0369@gmail.com",
      link: "mailto:deguzman0369@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Barangay Sta. Teresita, Quezon City, Philippines",
      link: "https://maps.app.goo.gl/wAqVVaTrzmJJdQzu5",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Nagareboshi09/",
    },
    {
